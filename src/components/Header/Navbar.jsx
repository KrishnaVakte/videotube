...
function Navbar() {
    ...
    return (
        <>
            <nav className="w-full bg-richblack-800 flex justify-between items-center p-4 sm:gap-5 gap-2 border-b-2 border-gray-500 sticky top-0 z-50">
                ...
                {authStatus ? (
                    ...
                    <div className="space-x-2 sm:block hidden">
                        <Link to={"/login"}>
                            <Button className="bg-purple border rounded-lg hover:bg-black border-slate-500 sm:px-4 sm:py-2 p-2">
                                Login
                            </Button>
                        </Link>
                        <Link to={"/signup"}>
                            <Button className="font-semibold rounded-lg bg-purple border hover:bg-[#222222] border-slate-500 sm:px-4 sm:py-2 ">
                                Sign up
                            </Button>
                        </Link>
                    </div>
                ...
                {toggleMenu && (
                    <div className="fixed right-0 top-0 text-white flex flex-col border-l h-screen w-[70%] bg-richblack-800 sm:hidden rounded-lg outline-none">
                        ...
                        <div className="flex flex-col justify-between h-full py-5 px-3 j">
                            <div className="flex flex-col gap-5">
                                {sidePanelItems.map((item) => (
                                    ...
                                    >
                                        <div className="flex items-center border border-slate-500 gap-5 px-3 py-1 hover:bg-purple">
                                            <div>{item.icon}</div>
                            ...
                            {!authStatus ? (
                                <div className="flex flex-col space-y-5 mb-3 ">
                                    <Link to={"/login"}>
                                        <Button className="w-full rounded-lg  bg-purple border hover:bg-white hover:text-black border-slate-500 py-1 px-3">
                                            Login
                                        </Button>
                                    </Link>
                                    <Link to={"/signup"}>
                                        <Button className=" w-full rounded-lg bg-purple font-semibold border border-slate-500 hover:bg-white hover:text-black py-1 px-3">
                                            Sign up
                                        </Button>
                                    </Link>
                                </div>
