...
import { Input2, Button, IconBtn } from "../components";
...
function EditPersonalInfo() {
    ...
    return (
        <>
            <div className="w-full text-richblack-5 flex justify-center items-center mt-5">
                <div className="bg-transparent p-5 border rounded shadow-lg w-full max-w-md ">
                    ...
                    >
                        ...
                        <div className="flex justify-between mt-4">
                            <IconBtn
                                onClick={(e) => reset(e)}
                                className="bg-richblack-700 text-white px-4 py-2 rounded"
                            >
                                Reset
                            </IconBtn>
                            <IconBtn
